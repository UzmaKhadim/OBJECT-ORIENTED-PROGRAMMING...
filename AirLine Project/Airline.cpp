...
void Airline::registerPassenger()
{
    ...
    type = readInt("Type (1=Economy  2=Business  3=FirstClass): ");
...
void Airline::passengerBookingDetails()
{
    if (tickets.empty())
    {
